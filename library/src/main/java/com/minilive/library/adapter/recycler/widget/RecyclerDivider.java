package com.minilive.library.adapter.recycler.widget;
...
import com.minilive.library.adapter.recycler.HeaderAndFooterAdapter;
...
public class RecyclerDivider extends RecyclerView.ItemDecoration {
    ...
    private RecyclerDivider(@DrawableRes int drawableResId) {
        mDividerDrawable = ContextCompat.getDrawable(BaseAdapterUtil.getApp(), drawableResId);
     ...
     * @return
     */
    public static RecyclerDivider newDrawableDivider(@DrawableRes int drawableResId) {
        return new RecyclerDivider(drawableResId);
    }
     ...
     * @return
     */
    public static RecyclerDivider newShapeDivider() {
        return new RecyclerDivider(R.drawable.bga_baseadapter_divider_shape);
    }

    public static RecyclerDivider newTransparentDivider(){
        return new RecyclerDivider(R.drawable.bga_divider_shape_transprent);
    }

    public static RecyclerDivider newTransparentDivider5height() {
        return new RecyclerDivider(R.drawable.bga_divider_shape_transprent_5);
    }

    public static RecyclerDivider newTransparentDivider4Width() {
        return new RecyclerDivider(R.drawable.bga_divider_shape_transprent_hor_4);
    }
     ...
     * @return
     */
    public static RecyclerDivider newBitmapDivider() {
        return new RecyclerDivider(R.mipmap.bga_baseadapter_divider_bitmap);
    }
     ...
     * @return
     */
    public RecyclerDivider setDelegate(Delegate delegate) {
        mDelegate = delegate;
        return this;
    }
     ...
     * @return
     */
    public RecyclerDivider setBothMarginResource(@DimenRes int resId) {
        mMarginLeft = BaseAdapterUtil.getDimensionPixelOffset(resId);
     ...
     * @return
     */
    public RecyclerDivider setBothMarginDp(int bothMarginDp) {
        mMarginLeft = BaseAdapterUtil.dp2px(bothMarginDp);
        mMarginRight = mMarginLeft;
        return this;
    }
     ...
     * @return
     */
    public RecyclerDivider setBothMarginPx(int bothMarginPx) {
     ...
     * @return
     */
    public RecyclerDivider setMarginLeftResource(@DimenRes int resId) {
        mMarginLeft = BaseAdapterUtil.getDimensionPixelOffset(resId);
        return this;
    }
     ...
     * @return
     */
    public RecyclerDivider setMarginLeftDp(int marginLeftDp) {
        mMarginLeft = BaseAdapterUtil.dp2px(marginLeftDp);
        return this;
    }
     ...
     * @return
     */
    public RecyclerDivider setMarginLeftPx(int marginLeftPx) {
     ...
     * @return
     */
    public RecyclerDivider setMarginRightResource(@DimenRes int resId) {
        mMarginRight = BaseAdapterUtil.getDimensionPixelOffset(resId);
        return this;
    }
     ...
     * @return
     */
    public RecyclerDivider setMarginRightDp(int marginRightDp) {
        mMarginRight = BaseAdapterUtil.dp2px(marginRightDp);
        return this;
    }
     ...
     * @return
     */
    public RecyclerDivider setMarginRightPx(int marginRightPx) {
     ...
     * @return
     */
    public RecyclerDivider setColorResource(@ColorRes int resId, boolean isSrcTop) {
        return setColor(BaseAdapterUtil.getColor(resId), isSrcTop);
    }
     ...
     * @return
     */
    public RecyclerDivider setColor(@ColorInt int color, boolean isSrcTop) {
     ...
     * @return
     */
    public RecyclerDivider setHorizontal() {
     ...
     * @return
     */
    public RecyclerDivider rotateDivider() {
        if (mDividerDrawable != null && mDividerDrawable instanceof BitmapDrawable) {
            mDividerDrawable = BaseAdapterUtil.rotateBitmap(((BitmapDrawable) mDividerDrawable).getBitmap());
        }
        return this;
    }
     ...
     * @return
     */
    public RecyclerDivider setStartSkipCount(@IntRange(from = 0) int startSkipCount) {
     ...
     * @return
     */
    public RecyclerDivider setEndSkipCount(@IntRange(from = 0) int endSkipCount) {
     ...
     * @return
     */
    public RecyclerDivider setSizeResource(@DimenRes int resId) {
        mSize = BaseAdapterUtil.getDimensionPixelOffset(resId);
        return this;
    }
     ...
     * @return
     */
    public RecyclerDivider setSizeDp(int sizeDp) {
        mSize = BaseAdapterUtil.dp2px(sizeDp);
        return this;
    }
     ...
     * @return
     */
    public RecyclerDivider setSizePx(int sizePx) {
        mSize = sizePx;
        return this;
    }
    ...
    private HeaderAndFooterAdapter getHeaderAndFooterAdapter(RecyclerView parent) {
        RecyclerView.Adapter adapter = parent.getAdapter();
        if (adapter instanceof HeaderAndFooterAdapter) {
            return (HeaderAndFooterAdapter) adapter;
        } else {
            return null;
        }
    }

    private boolean isNeedSkip(int childAdapterPosition, HeaderAndFooterAdapter headerAndFooterAdapter, int realChildAdapterPosition, int realItemCount) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        HeaderAndFooterAdapter headerAndFooterAdapter = getHeaderAndFooterAdapter(parent);
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent, HeaderAndFooterAdapter headerAndFooterAdapter, int itemCount, int realItemCount, boolean
            isDrawOver) {
    ...
    private int getRealChildAdapterPosition(int childAdapterPosition, HeaderAndFooterAdapter headerAndFooterAdapter) {
        if (headerAndFooterAdapter != null) {
            // 转换成真实 item 的索引
    ...
    public interface Delegate {
        ...
        void getItemOffsets(RecyclerDivider divider, int position, int itemCount, Rect outRect);

        void drawVertical(RecyclerDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, int position, int itemCount);

        void drawOverVertical(RecyclerDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, int position, int itemCount);
    }
    ...
    public static class SimpleDelegate implements Delegate {
        ...
        @Override
        public void getItemOffsets(RecyclerDivider divider, int position, int itemCount, Rect outRect) {
        }

        @Override
        public void drawVertical(RecyclerDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, int position, int itemCount) {
        }

        @Override
        public void drawOverVertical(RecyclerDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, int position, int itemCount) {
        }
    }
    ...
    public static abstract class StickyDelegate extends SimpleDelegate {
        ...
        protected void initAttr() {
            ...
            mCategoryPaddingLeft = BaseAdapterUtil.dp2px(16);
            mCategoryTextSize = BaseAdapterUtil.sp2px(14);
            mCategoryHeight = BaseAdapterUtil.dp2px(32);
         ...
         * 绘制悬浮分类
         */
        protected void drawOverCategory(RecyclerDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, String category) {
         ...
         * 绘制普通分类
         */
        protected void drawCategory(RecyclerDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, String category) {
            // 绘制背景
