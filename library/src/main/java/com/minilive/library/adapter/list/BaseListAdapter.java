...
import com.minilive.library.adapter.AdapterUtil;
...
public abstract class BaseListAdapter<M> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ListAdapterViewHolder viewHolder = ListAdapterViewHolder.dequeueReusableAdapterViewHolder(convertView, parent, mItemLayoutId);
