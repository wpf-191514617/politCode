...
//        }
        ...
        holder.layoutTab = view.findViewById(R.id.layoutTab);
    ...
    public void onClick(View v) {
        ...
        if (object != null && object instanceof ViewHolder) {
            ...
            if (mTabSelectListener != null) {
               boolean isShow = mTabSelectListener.onTabSelected(holder);
               if (isShow){
                    showFragment(holder);
                }
                return;
    ...
    private void setCurrSelectedTabByTag(String tag) {
        ...
        for (ViewHolder holder : mViewHolderList) {
            if (TextUtils.equals(mCurrentTag, holder.tag)) {
                ...
                holder.tabTitle.setTextColor(mNormalTextColor);
                holder.layoutTab.setBackgroundColor(getResources().getColor(R.color.gray_ee));
                ...
                holder.layoutTab.setBackgroundColor(getResources().getColor(R.color.blue));
            }
        }
        mCurrentTag = tag;
    }
    ...
    public static class TabParam {
        public int backgroundColor = R.color.gray_ee;
