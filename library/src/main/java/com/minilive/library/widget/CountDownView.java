...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mPaintArcWidth = array.getDimension(R.styleable.CountDownView_cd_arc_width, dip2px
                (context, 3));//默认3dp
        mPaintArcColor = array.getColor(R.styleable.CountDownView_cd_arc_color, mPaintArcColor);
        mTextSize = (int) array.getDimension(R.styleable.CountDownView_cd_text_size, dip2px
                (context, 14));//默认14sp
        mTextColor = array.getColor(R.styleable.CountDownView_cd_text_color, mTextColor);
        mPaintBackGroundColor = array.getColor(R.styleable.CountDownView_cd_bg_color,
...
//        }
        ...
        mAnimatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                clearAnimation();
                if (loadingFinishListener != null && endTime - mStartTime >= mLoadingTime * 1000) {
    ...
    public void setIsCustomContent(boolean isCustom){
        this.isCustom = isCustom;
    }

    public void customTextContent(int time) {
        if (isCustom){
            mText = mLoadingTimeUnit;
        } else {
