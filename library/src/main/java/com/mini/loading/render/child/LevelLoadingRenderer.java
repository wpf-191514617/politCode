package com.mini.loading.render.child;
...
import com.mini.loading.render.LoadingRenderer;
...
public class LevelLoadingRenderer extends LoadingRenderer {
    ...
    private static final float[] LEVEL_SWEEP_ANGLE_OFFSETS = new float[]{1.0f, 8.0f / 8.0f, 8.0f
            / 8.0f};
    ...
    /*private static final int[] DEFAULT_LEVEL_COLORS = new int[]{Color.parseColor("#ffffffff"),
            Color.parseColor("#ffffffff"), Color.parseColor("#ffffffff")};*/

    private static final int[] DEFAULT_LEVEL_COLORS = new int[]{Color.parseColor("#7826f4"),
            Color.parseColor("#7826f4"), Color.parseColor("#7826f4")};
