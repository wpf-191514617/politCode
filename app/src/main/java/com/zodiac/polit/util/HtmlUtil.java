...
public class HtmlUtil {
    ...
    public static final String MOBILE = "http://m.kjzfw.mil.cn";
    ...
    public static String getHtmlText(String html) {
        ...
        return m1.replaceAll("").trim().toString();
    }


    public static String getDetailUrl(String id, String categoryId){
       // return Constant.BASEURL + "/airforce/mobile/indexinfo.html?id=" + id + "-" + categoryId + "&p=1";
        return MOBILE + "/indexinfo.html?id=" + id + "-" + categoryId + "&p=1";
    }
